...
(function(T, O) {
    ...
    O(n, "Core/Utilities.js", [n["Core/Globals.js"]], function(f) {
        ...
        var L = function() {
            ...
            b.prototype.update = function() {
                ...
                if (this[c + "Setter"])
                    ...
                    b.attr ? b.element && b.attr(c, e, null, !0) : b.style[c] = e + this.unit;
                d && d.call(b, e, this)
            }
            ;
            b.prototype.run = function(b, c, e) {
                ...
                w.elem = this.elem,
                w.prop = this.prop,
                w() && 1 === f.timers.push(w) && g(h)) : (delete z.curAnim[this.prop],
        ...
        var d = f.css = function(b, c) {
          ...
          , F = f.normalizeTickInterval = function(b, c, e, d, z) {
            ...
            e = G(e, 1);
            var g = b / e;
            c || (c = z ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10],
            !1 === d && (1 === e ? c = c.filter(function(b) {
                return 0 === b % 1
            }) : .1 >= e && (c = [1 / e])));
            for (d = 0; d < c.length && !(w = c[d],
            z && w * e >= b || !z && g <= (c[d] + (c[d + 1] || c[d])) / 2); d++)
                ;
          ...
          , X = f.numberFormat = function(b, c, e, d) {
            ...
            if (-1 === c)
                ...
                var h = c + +g[1];
                0 <= h ? (g[0] = (+g[0]).toExponential(h).split("e")[0],
                c = h) : (g[0] = g[0].split(".")[0] || 0,
        ...
        var ba = f.getStyle = function(b, c, e) {
            if ("width" === c)
                return c = Math.min(b.offsetWidth, b.scrollWidth),
            ...
            if ("height" === c)
                return Math.max(0, Math.min(b.offsetHeight, b.scrollHeight) - f.getStyle(b, "padding-top") - f.getStyle(b, "padding-bottom"));
        ...
        , ka = f.animate = function(b, c, e) {
            ...
            U(c, function(h, k) {
                ...
                g = new L(b,e,k);
                w = null;
                "d" === k && E(c.d) ? (g.paths = g.initPath(b, b.pathArray, c.d),
                g.toD = c.d,
                d = 0,
                w = 1) : b.attr ? d = b.attr(k) : (d = parseFloat(ba(b, k)) || 0,
                "opacity" !== k && (z = "px"));
                w || (w = h);
        ...
        v.jQuery && (v.jQuery.fn.highcharts = function() {
            ...
            if (this[0])
                return b[0] ? (new (f[K(b[0]) ? b.shift() : "Chart"])(this[0],b[0],b[1]),
                this) : J[n(this[0], "data-highcharts-chart")]
        }
        );
        return {
            Fx: f.Fx,
        ...
        a = function() {
            ...
            a.prototype.get = function(a) {
                ...
                if ("undefined" !== typeof this.stops) {
                    ...
                    v = H && S(H[0]) ? "rgb" === a || !a && 1 === H[3] ? "rgb(" + H[0] + "," + H[1] + "," + H[2] + ")" : "a" === a ? H[3] : "rgba(" + H.join(",") + ")" : f;
                return v
            }
            ;
            ...
            a.prototype.tweenTo = function(a, f) {
                var H = this.rgba
                  , v = a.rgba;
                v.length && H && H.length ? (a = 1 !== v[3] || 1 !== H[3],
                f = (a ? "rgba(" : "rgb(") + Math.round(v[0] + (H[0] - v[0]) * (1 - f)) + "," + Math.round(v[1] + (H[1] - v[1]) * (1 - f)) + "," + Math.round(v[2] + (H[2] - v[2]) * (1 - f)) + (a ? "," + (v[3] + (H[3] - v[3]) * (1 - f)) : "") + ")") : f = a.input || "none";
                return f
            }
            ;
            a.names = {
    ...
    O(n, "Core/Renderer/SVG/SVGElement.js", [n["Core/Color.js"], n["Core/Globals.js"], n["Core/Utilities.js"]], function(f, a, n) {
        ...
        n = function() {
            ...
            F.prototype.animate = function(e, c, b) {
                ...
                0 !== w.duration ? (b && (w.complete = b),
                M(function() {
                    d.element && q(d, e, w)
                }, c)) : (this.attr(e, void 0, b),
                r(e, function(b, c) {
            ...
            F.prototype.applyTextOutline = function(e) {
                ...
                if ((b = e[0]) && "none" !== b && a.svg) {
                    ...
                    e.forEach(function(e, z) {
                        0 === z && (e.setAttribute("x", c.getAttribute("x")),
                        z = c.getAttribute("y"),
            ...
            F.prototype.attr = function(e, c, b, d) {
                ...
                "string" === typeof e ? h = (this[e + "Getter"] || this._defaultGetter).call(this, e, z) : (r(e, function(b, c) {
                    k = !1;
                    d || B(this, c);
                    this.symbolName && -1 !== m.indexOf(c) && (g || (this.symbolAttr(e),
                    g = !0),
                    k = !0);
                    !this.rotation || "x" !== c && "y" !== c || (this.doTransform = !0);
                    k || (l = this[c + "Setter"] || this._defaultSetter,
                    l.call(this, b, c, z),
                    !this.styledMode && this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(c) && this.updateShadows(c, b, l))
                }, this),
                this.afterSetters());
                b && b.call(this);
                return h
            ...
            F.prototype.complexColor = function(e, c, b) {
                ...
                h(this.renderer, "complexColor", {
                    ...
                    if (g) {
                        ...
                        "radialGradient" === g && u && !I(k.gradientUnits) && (m = k,
                        ...
                        if (p[Q])
                            ...
                            B.forEach(function(b) {
                                0 === b[1].indexOf("rgba") ? (w = f.parse(b[1]),
                                t = w.get("rgb"),
                                A = w.get("a")) : (t = b[1],
                                A = 1);
            ...
            F.prototype.dSetter = function(e, c, b) {
                l(e) && ("string" === typeof e[0] && (e = this.renderer.pathToSegments(e)),
                this.pathArray = e,
            ...
            F.prototype.getBBox = function(e, c) {
                var b, d = this.renderer, w = this.element, g = this.styles, h = this.textStr, l = d.cache, r = d.cacheKeys, x = w.namespaceURI === this.SVG_NS;
            ...
            F.prototype.removeTextOutline = function(e) {
                for (var c = e.length, b; c--; )
                    b = e[c],
                    "highcharts-text-outline" === b.getAttribute("class") && u(e, this.element.removeChild(b))
            }
            ;
            ...
            F.prototype.setTextPath = function(e, c) {
                ...
                var l = c.attributes;
                if (e && c && c.enabled) {
                    k && null === k.element.parentNode ? (h = !0,
                    k = k.destroy()) : k && this.removeTextOutline.call(k.parentGroup, [].slice.call(b.getElementsByTagName("tspan")));
                    this.options && this.options.padding && (l.dx = -this.options.padding);
                    k || (this.textPathWrapper = k = this.renderer.createElement("textPath"),
                    w = !0);
                    var m = k.element;
                    ...
                    I(l.dy) && (m.parentNode.setAttribute("dy", l.dy),
                    delete l.dy);
                    I(l.dx) && (m.parentNode.setAttribute("dx", l.dx),
                    delete l.dx);
                    r(l, function(b, c) {
            ...
            F.prototype.shadow = function(e, c, b) {
                ...
                if (!x)
                    ...
                    for (l = 1; l <= x.width; l++) {
                        ...
                        b && (E(t, "height", Math.max(E(t, "height") - A, 0)),
                        t.cutHeight = A);
            ...
            F.prototype.strokeSetter = function(e, c, b) {
                ...
                this.hasStroke = !0) : "stroke-width" === c && 0 === e && this.hasStroke ? (b.removeAttribute("stroke"),
            ...
            F.prototype.textSetter = function(e) {
                e !== this.textStr && (delete this.textPxLength,
                this.textStr = e,
            ...
            F.prototype.titleSetter = function(e) {
                ...
                c || (c = D.createElementNS(this.SVG_NS, "title"),
            ...
            F.prototype.zIndexSetter = function(e, c) {
                ...
                var l = this.added;
                var r;
                I(e) ? (k.setAttribute("data-z-index", e),
                e = +e,
                this[c] === e && (l = !1)) : I(this[c]) && k.removeAttribute("data-z-index");
                this[c] = e;
                if (l) {
                    ...
                    for (r = c.length - 1; 0 <= r && !h; r--) {
                        ...
                        if (d !== k)
                            if (0 > e && m && !b && !r)
                                g.insertBefore(k, c[r]),
                                h = !0;
                            else if (N(l) <= e || m && (!I(e) || 0 <= e))
                                g.insertBefore(k, c[r + 1] || null),
                                h = !0
                    }
                    h || (g.insertBefore(k, c[b ? 3 : 0] || null),
                    h = !0)
                }
                return h
            }
    ...
    O(n, "Core/Renderer/SVG/SVGLabel.js", [n["Core/Renderer/SVG/SVGElement.js"], n["Core/Utilities.js"]], function(f, a) {
        var n = this && this.__extends || function() {
            ...
            return function(f, L) {
                ...
                a(f, L);
                f.prototype = null === L ? Object.create(L) : (q.prototype = L.prototype,
                new q)
            }
        }()
          , y = a.defined
        ...
        return function(a) {
            ...
            v.prototype.alignSetter = function(a) {
                ...
                this.bBox && G(this.xSetting) && this.attr({
                    x: this.xSetting
                }))
            }
            ;
            ...
            v.prototype.paddingSetter = function(a) {
                y(a) && a !== this.padding && (this.padding = a,
                this.updateTextPadding())
            }
            ;
            v.prototype.paddingLeftSetter = function(a) {
                y(a) && a !== this.paddingLeft && (this.paddingLeft = a,
                this.updateTextPadding())
            }
            ;
            ...
            v.prototype.xSetter = function(a) {
                this.x = a;
                this.alignFactor && (a -= this.alignFactor * ((this.widthSetting || this.bBox.width) + 2 * this.padding),
        ...
        var B = a.svg
          ...
          , e = function() {
            ...
            c.prototype.buildText = function(b) {
                var c = b.element, e = this, d = e.forExport, g = m(b.textStr, "").toString(), k = -1 !== g.indexOf("<"), l = c.childNodes, r, p = C(c, "x"), a = b.styles, A = b.textWidth, I = a && a.lineHeight, Q = a && a.textOutline, f = a && "ellipsis" === a.textOverflow, F = a && "nowrap" === a.whiteSpace, N = a && a.fontSize, q, E = l.length;
                ...
                var v = function(b) {
                  ...
                  , n = function(b, c) {
                    ...
                    e = b.indexOf(c + "=");
                    if (-1 !== e && (e = e + c.length + 1,
                    c = b.charAt(e),
                    '"' === c || "'" === c))
                        return b = b.substring(e + 1),
                ...
                if (J !== b.textCache) {
                    for (b.textCache = J; E--; )
                        c.removeChild(l[E]);
                    k || Q || f || A || -1 !== g.indexOf(" ") && (!F || K.test(g)) ? (a && a.appendChild(c),
                    k ? (g = e.styledMode ? g.replace(/<(b|strong)>/g, '<span class="highcharts-strong">').replace(/<(i|em)>/g, '<span class="highcharts-emphasized">') : g.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">'),
                    g = g.replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(K)) : g = [g],
                                ...
                                if (" " !== g) {
                                    ...
                                    if (A) {
                                        ...
                                        if (f)
                                            ...
                                            for (; Q.length; )
                                                Q.length && !F && 0 < t && (m = x.createElementNS(M, "tspan"),
                                                C(m, {
                                                    dy: a,
                                                    x: p
                                                }),
                    ...
                    a && a.removeChild(c),
                    t(Q) && b.applyTextOutline && b.applyTextOutline(Q)) : c.appendChild(x.createTextNode(R(g)))
                }
            }
            ;
            ...
            c.prototype.image = function(b, c, e, d, g, k) {
                ...
                k ? (h(l.element, "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="),
                w = new F.Image,
                G(w, "load", z),
                w.src = b,
                w.complete && z({})) : h(l.element, b);
                return l
            }
            ;
            c.prototype.symbol = function(b, c, e, d, k, h) {
                var w = this, z = /^url\((.*?)\)$/, l = z.test(b), r = !l && (this.symbols[b] ? b : "circle"), P = r && this.symbols[r], t;
                if (P) {
                    ...
                    ["width", "height"].forEach(function(b) {
                        a[b + "Setter"] = function(b, c) {
                            ...
                            this[c] = b;
                            v(d) && (h && "within" === h.backgroundSize && this.width && this.height && (d = Math.round(d * Math.min(this.width / this.imgwidth, this.height / this.imgheight))),
                            this.element && this.element.setAttribute(c, d),
                            this.alignByTranslate || (e[g] = ((this[c] || 0) - d) / 2,
                            this.attr(e)))
                        }
                    });
                    v(c) && a.attr({
            ...
            c.prototype.pathToSegments = function(b) {
                for (var c = [], e = [], d = {
                    ...
                    "string" === typeof b[g] && (e.length && c.push(e.slice(0)),
                    e.length = 0),
                    e.push(b[g]);
                c.push(e.slice(0));
                return c
        ...
        H(a.prototype, {
            ...
            htmlUpdateTransform: function() {
                if (this.added) {
                    ...
                    if ("SPAN" === p.tagName) {
                        d = this.rotation;
                        var r = this.textWidth && L(this.textWidth), A = [d, k, p.innerHTML, this.textWidth, this.textAlign].join(), f;
                        ...
                        A !== this.cTT && (x = a.fontMetrics(p.style.fontSize, p).b,
        ...
        H(n.prototype, {
            ...
            html: function(p, f, u) {
                ...
                m.textSetter = function(d) {
                    d !== h.innerHTML && (delete this.bBox,
    ...
    O(n, "Core/Axis/Tick.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function(f, a) {
        ...
        a = function() {
            ...
            a.prototype.handleOverflow = function(a) {
                ...
                var k = this.label, g = this.rotation, d = {
                    left: 0,
                    center: .5,
                    right: 1
                }[p.labelAlign || k.attr("align")], x = k.getBBox().width, r = p.getSlotWidth(this), A = r, N = 1, B, M = {};
                if (g || "justify" !== q(f.overflow, "justify"))
                    0 > g && u - d * x < l ? B = Math.round(u / Math.cos(g * K) - l) : 0 < g && u + d * x > h && (B = Math.round((m - u) / Math.cos(g * K)));
                else if (m = u + (1 - d) * x,
                u - d * x < l ? A = a.x + A * (1 - d) - l : m > h && (A = h - a.x + A * d,
                N = -1),
                A = Math.min(r, A),
                A < r && "center" === p.labelAlign && (a.x += N * (r - A - d * (r - Math.min(x, A)))),
                x > A || p.autoRotation && (k.styles || {}).width)
                    B = A;
                B && (this.shortenLabel ? this.shortenLabel() : (M.width = Math.floor(B) + "px",
            ...
            a.prototype.moveLabel = function(a, t) {
                var p = this
                  ...
                  , h = p.axis
                  , l = h.reversed;
                f && f.textStr === a ? (p.movedLabel = f,
                m = !0,
                delete p.label) : L(h.ticks, function(g) {
                    m || g.isNew || g === p || !g.label || g.label.textStr !== a || (p.movedLabel = g.label,
                    m = !0,
            ...
            a.prototype.renderGridLine = function(a, t, f) {
                var p = this.axis
                  ...
                  , N = m[r + "LineColor"];
                m = m[r + "LineDashStyle"];
                h || (p.chart.styledMode || (l.stroke = N,
                l["stroke-width"] = A,
                m && (l.dashstyle = m)),
                g || (l.zIndex = 1),
                a && (t = 0),
                this.gridLine = h = x.path().attr(l).addClass("highcharts-" + (g ? g + "-" : "") + "grid-line").add(p.gridGroup));
            ...
            a.prototype.renderMark = function(a, t, f) {
                ...
                m = m[k + "Color"];
                g && (p.opposite && (g[0] = -g[0]),
                x && (this.mark = d = h.path().addClass("highcharts-" + (l ? l + "-" : "") + "tick").add(p.axisGroup),
            ...
            a.prototype.renderLabel = function(a, f, I, u) {
                ...
                var x = !0
                  , r = a.x;
                a = a.y;
                k && H(r) && (k.xy = a = this.getLabelPosition(r, a, k, h, g, m, u, d),
        ...
        a = function() {
            ...
            a.prototype.makeTime = function(a, t, q, u, m, h) {
                if (this.useUTC) {
                    ...
                    l = (new this.Date(a,t,v(q, 1),v(u, 0),v(m, 0),v(h, 0))).getTime();
                return l
            }
            ;
            ...
            a.prototype.getTimeTicks = function(a, f, I, u) {
                ...
                if (n(f)) {
                    ...
                    for (k = 1; f < I; )
                        h.push(f),
                        f = g === q.year ? m.makeTime(r + k * d, 0) : g === q.month ? m.makeTime(r, u + k * d) : !x || g !== q.day && g !== q.week ? x && g === q.hour && 1 < d ? m.makeTime(r, u, p, t + k * d) : f + g * d : m.makeTime(r, u, p + k * d * (g === q.day ? 1 : 7)),
                        k++;
                    h.push(f);
    ...
    O(n, "Core/Options.js", [n["Core/Globals.js"], n["Core/Time.js"], n["Core/Color.js"], n["Core/Utilities.js"]], function(f, a, n, y) {
        ...
        f.defaultOptions = {
            ...
            credits: {
                ...
                text: "Sekolak.com - Highcharts JS"
            }
        };
        "";
    ...
    O(n, "Core/Axis/Axis.js", [n["Core/Color.js"], n["Core/Globals.js"], n["Core/Axis/Tick.js"], n["Core/Utilities.js"], n["Core/Options.js"]], function(f, a, n, y, D) {
        ...
        y = function() {
            ...
            e.prototype.init = function(c, b) {
                ...
                b = d.options.events;
                -1 === c.axes.indexOf(d) && (e ? c.axes.splice(c.xAxis.length, 0, d) : c.axes.push(d),
                c[d.coll].push(d));
                d.series = d.series || [];
                        ...
                        if (d.visible || !b.options.chart.ignoreHiddenSeries) {
                            ...
                            if (c.isXAxis) {
                                ...
                                g.length) {
                                    ...
                                    var h = e.min;
                                    var a = e.max;
                                    l(h) || h instanceof Date || (g = g.filter(l),
                                    e = d.getXExtremes(g),
                                    h = e.min,
                                    a = e.max);
                                    g.length && (c.dataMin = Math.min(r(c.dataMin, h), h),
                                    c.dataMax = Math.max(r(c.dataMax, a), a))
                                }
                            } else if (d = d.applyExtremes(),
                            l(d.dataMin) && (h = d.dataMin,
                            c.dataMin = Math.min(r(c.dataMin, h), h)),
                            l(d.dataMax) && (a = d.dataMax,
                            c.dataMax = Math.max(r(c.dataMax, a), a)),
                            q(k) && (c.threshold = k),
            ...
            e.prototype.translate = function(c, b, e, d, g, k) {
                ...
                w -= a * (h.sector || h.len));
                b ? (c = (c * a + w - r) / z + d,
                g && (c = h.lin2val(c))) : (g && (c = h.val2lin(c)),
            ...
            e.prototype.getPlotLinePath = function(c) {
                ...
                var e = this, d = e.chart, g = e.left, k = e.top, h = c.old, a = c.value, m = c.translatedValue, x = c.lineWidth, f = c.force, p, B, A, M, F = h && d.oldChartHeight || d.chartHeight, u = h && d.oldChartWidth || d.chartWidth, q, N = e.transB;
                c = {
                    value: a,
                    lineWidth: x,
                    old: h,
                ...
                t(this, "getPlotLinePath", c, function(c) {
                    ...
                    l(m) ? e.horiz ? (B = k,
                    M = F - e.bottom,
                    p = A = b(p, g, g + e.width)) : (p = g,
                    A = u - e.right,
                    B = M = b(B, k, k + e.height)) : (q = !0,
                    f = !1);
            ...
            e.prototype.nameToX = function(c) {
                ...
                if (-1 === d) {
                    ...
                    g = d;
                "undefined" !== typeof g && (this.names[g] = c.name,
                ...
                (this.series || []).forEach(function(b) {
                    ...
                    b.data.forEach(function(e, d) {
                        if (e && e.options && "undefined" !== typeof e.name) {
                            var g = c.nameToX(e);
                            "undefined" !== typeof g && g !== e.x && (e.x = g,
                            b.xData[d] = g)
                        }
                    })
                }))
            ...
            e.prototype.setAxisTranslation = function(c) {
                ...
                if (x || l || d) {
                    var f = b.getClosest();
                    a ? (g = a.minPointOffset,
                    h = a.pointRangePadding) : b.series.forEach(function(c) {
            ...
            e.prototype.setTickInterval = function(c) {
                ...
                g && (b.positiveValuesOnly && !c && 0 >= Math.min(b.min, r(b.dataMin, b.min)) && E(10, 1, e),
                b.min = L(g.log2lin(b.min), 16),
                b.max = L(g.log2lin(b.max), 16));
                b.range && q(b.max) && (b.userMin = b.min = M = Math.max(b.dataMin, b.minFromRange()),
                b.userMax = F = b.max,
                b.range = null);
                t(b, "foundExtremes");
                b.beforePadding && b.beforePadding();
                b.adjustForMinRange();
                !(B || b.axisPointRange || b.stacking && b.stacking.usePercentage || a) && q(b.min) && q(b.max) && (e = b.max - b.min) && (!q(M) && x && (b.min -= e * x),
                !q(F) && m && (b.max += e * m));
                l(b.userMin) || (l(k.softMin) && k.softMin < b.min && (b.min = M = k.softMin),
                l(k.floor) && (b.min = Math.max(b.min, k.floor)));
                l(b.userMax) || (l(k.softMax) && k.softMax > b.max && (b.max = F = k.softMax),
            ...
            e.prototype.setTickPositions = function() {
                ...
                !e && (this.ordinal && this.ordinal.positions || !((this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)) ? e = this.dateTime ? this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, c.units), this.min, this.max, c.startOfWeek, this.ordinal && this.ordinal.positions, this.closestPointRange, !0) : this.logarithmic ? this.logarithmic.getLogTickPositions(this.tickInterval, this.min, this.max) : this.getLinearTickPositions(this.tickInterval, this.min, this.max) : (e = [this.min, this.max],
                E(19, !1, this.chart)),
                e.length > this.len && (e = [e[0], e.pop()],
                e[0] === e[1] && (e.length = 1)),
                this.tickPositions = e,
                d && (d = d.apply(this, [this.min, this.max]))) && (this.tickPositions = e = d);
            ...
            e.prototype.adjustTickAmount = function() {
                var c = this.options, b = this.tickInterval, e = this.tickPositions, d = this.tickAmount, g = this.finalTickAmt, k = e && e.length, h = r(this.threshold, this.softThreshold ? 0 : null), a;
                if (this.hasData()) {
                    if (k < d) {
            ...
            e.prototype.setScale = function() {
                ...
                this.setAxisSize();
                (c = this.len !== this.oldAxisLength) || b || e || this.isLinked || this.forceRedraw || this.userMin !== this.oldUserMin || this.userMax !== this.oldUserMax || this.alignToOthers() ? (this.stacking && this.stacking.resetStacks(),
                this.forceRedraw = !1,
            ...
            e.prototype.zoom = function(c, b) {
                ...
                t(this, "zoom", c, function(b) {
                    var c = b.newMin
                      , k = b.newMax;
                    if (c !== e.min || k !== e.max)
                        e.allowZoomOutside || (q(d) && (c < h && (c = h),
                        c > a && (c = a)),
                        q(g) && (k < h && (k = h),
                        k > a && (k = a))),
            ...
            e.prototype.unsquish = function() {
                var c = this.options.labels, b = this.horiz, e = this.tickInterval, d = e, g = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / e), k, h = c.rotation, a = this.labelMetrics(), l, m = Number.MAX_VALUE, x, f = this.max - this.min, p = function(b) {
                    var c = b / (g || 1);
                    c = 1 < c ? Math.ceil(c) : 1;
            ...
            e.prototype.getSlotWidth = function(c) {
                var b, e = this.chart, d = this.horiz, g = this.options.labels, k = Math.max(this.tickPositions.length - (this.categories ? 0 : 1), 1), h = e.margin[3];
                if (c && l(c.slotWidth))
                    return c.slotWidth;
                if (d && g && 2 > (g.step || 0))
            ...
            e.prototype.renderUnsquish = function() {
                ...
                if (this.autoRotation)
                    ...
                    if (!f) {
                        ...
                        for (m = e.length; !a && m--; ) {
                            var t = e[m];
                            if (t = d[t].label)
                                t.styles && "ellipsis" === t.styles.textOverflow ? t.css({
                                    textOverflow: "clip"
                ...
                r.rotation && (B = p > .5 * c.chartHeight ? .33 * c.chartHeight : p,
                f || (A = "ellipsis"));
                ...
                e.forEach(function(b) {
                    var c = (b = d[b]) && b.label
                      ...
                      , g = {};
                    c && (c.attr(r),
                    b.shortenLabel ? b.shortenLabel() : B && !e && "nowrap" !== h.whiteSpace && (B < c.textPxLength || "SPAN" === c.element.tagName) ? (g.width = B + "px",
                    f || (g.textOverflow = c.specificTextOverflow || A),
                    c.css(g)) : c.styles && c.styles.width && !g.width && !e && c.css({
                        width: null
                    }),
            ...
            e.prototype.addTitle = function(c) {
                var b = this.chart.renderer, e = this.horiz, d = this.opposite, k = this.options.title, h, a = this.chart.styledMode;
                ...
                this.axisTitle = b.text(k.text, 0, 0, k.useHTML).attr({
                    zIndex: 7,
            ...
            e.prototype.getOffset = function() {
                var c = this, b = c.chart, e = b.renderer, d = c.options, g = c.tickPositions, k = c.ticks, h = c.horiz, a = c.side, l = b.inverted && !c.isZAxis ? [1, 0, 3, 2][a] : a, m, f = 0, p = 0, B = d.title, A = d.labels, M = 0, F = b.axisOffset;
                b = b.clipOffset;
                var u = [-1, 1, 1, -1][a]
                  , N = d.className
                  , v = c.axisParent;
                ...
                c.axisGroup = e.g("axis").attr({
                    zIndex: d.zIndex || 2
                }).addClass("highcharts-" + this.coll.toLowerCase() + " " + (N || "")).add(v),
                c.labelGroup = e.g("axis-labels").attr({
                    zIndex: A.zIndex || 7
                ...
                c.renderUnsquish(),
                c.reserveSpaceDefault = 0 === a || 2 === a || {
                    1: "left",
                    3: "right"
                }[a] === c.labelAlign,
                r(A.reserveSpace, "center" === c.labelAlign ? !0 : null, c.reserveSpaceDefault) && g.forEach(function(b) {
                    M = Math.max(k[b].getLabelSize(), M)
                }),
                c.staggerLines && (M *= c.staggerLines),
                c.labelOffset = M * (c.opposite ? -1 : 1)) : x(k, function(b, c) {
                    b.destroy();
                    delete k[c]
                });
                if (B && B.text && !1 !== B.enabled && (c.addTitle(m),
                m && !1 !== B.reserveSpace)) {
            ...
            e.prototype.render = function() {
                var c = this, b = c.chart, e = c.logarithmic, d = c.options, g = c.isLinked, k = c.tickPositions, h = c.axisTitle, m = c.ticks, r = c.minorTicks, f = c.alternateBands, p = d.stackLabels, B = d.alternateGridColor, A = c.tickmarkOffset, Q = c.axisLine, F = c.showAxis, u = C(b.renderer.globalAnimation), q, N;
                ...
                if (c.hasData() || g)
                    ...
                    A && (0 === c.min || c.single) && (m[-1] || (m[-1] = new n(c,-1,null,!0)),
                    m[-1].render(-1))),
                    B && k.forEach(function(d, g) {
                        N = "undefined" !== typeof k[g + 1] ? k[g + 1] + A : c.max - A;
                        0 === g % 2 && d < c.max && N <= c.max + (b.polar ? -A : A) && (f[d] || (f[d] = new a.PlotLineOrBand(c)),
                        q = d + A,
                        f[d].options = {
                ...
                [m, r, f].forEach(function(c) {
                    ...
                    M(function() {
                        for (e = d.length; e--; )
                            c[d[e]] && !c[d[e]].isActive && (c[d[e]].destroy(),
                            delete c[d[e]])
                ...
                Q.isPlaced = !0,
                Q[F ? "show" : "hide"](F));
                h && F && (d = c.getTitlePosition(),
                l(d.y) ? (h[h.isNew ? "attr" : "animate"](d),
                h.isNew = !1) : (h.attr("y", -9999),
                h.isNew = !0));
            ...
            e.prototype.destroy = function(c) {
                var b = this, e = b.plotLinesAndBands, d;
                t(this, "destroy", {
                    keepEvents: c
                });
                c || N(b);
        ...
        var n = a.addEvent
          ...
          , C = function() {
            ...
            a.prototype.normalizeTimeTickInterval = function(a, f) {
                ...
                f = v[v.length - 1];
                var q = G[f[0]], H = f[1], E;
                for (E = 0; E < v.length && !(f = v[E],
                q = G[f[0]],
                H = f[1],
                v[E + 1] && a <= (q * H[H.length - 1] + G[v[E + 1][0]]) / 2); E++)
                    ;
        ...
        a = function() {
            ...
            a.compose = function(a) {
                ...
                n(a, "init", function(a) {
                    ...
                    "logarithmic" !== a.userOptions.type ? this.logarithmic = void 0 : (f || (f = this.logarithmic = new C(this)),
        ...
        var y = n.arrayMax
          ...
          , K = function() {
            ...
            f.prototype.render = function() {
                ...
                k = u.log2lin(k),
                d = u.log2lin(d));
                t.chart.styledMode || (r ? (B.stroke = M || "#999999",
                B["stroke-width"] = q(m.width, 1),
                m.dashStyle && (B.dashstyle = m.dashStyle)) : x && (B.fill = M || "#e6ebf5",
                m.borderWidth && (B.stroke = m.borderColor,
                ...
                this.renderLabel(h, B, x, R)) : l && l.hide();
                return f
            }
            ;
                ...
                if (q && p) {
                    ...
                    for (a = 0; a < q.length; a += 2) {
                        ...
                        var k = q[a + 1]
                          , g = p[a]
                          , d = p[a + 1];
                        "M" !== f[0] && "L" !== f[0] || "M" !== k[0] && "L" !== k[0] || "M" !== g[0] && "L" !== g[0] || "M" !== d[0] && "L" !== d[0] || (m && g[1] === f[1] ? (g[1] += h,
                        d[1] += h) : m || g[2] !== f[2] || (g[2] += h,
                        d[2] += h),
    ...
    O(n, "Core/Tooltip.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function(f, a) {
        ...
        var u = function() {
            ...
            m.prototype.getAnchor = function(h, a) {
                ...
                h = p(h);
                this.followPointer && a ? ("undefined" === typeof a.chartX && (a = g.normalize(a)),
                h = [a.chartX - f, a.chartY - l]) : h[0].tooltipPos ? h = h[0].tooltipPos : (h.forEach(function(g) {
                    B = g.series.yAxis;
                    M = g.series.xAxis;
            ...
            m.prototype.getDateFormat = function(h, a, k, g) {
                ...
                if (p)
                    var B = d.resolveDTLFormat(g[p]).main;
                return B
            }
            ;
            m.prototype.getLabel = function() {
                var h, a, k = this, g = this.chart.renderer, d = this.chart.styledMode, m = this.options, r = "tooltip" + (G(m.className) ? " " + m.className : ""), p = (null === (h = m.style) || void 0 === h ? void 0 : h.pointerEvents) || (!this.followPointer && m.stickOnContact ? "auto" : "none"), t;
                h = function() {
                    k.inContact = !0
                }
                ;
                ...
                if (!this.label) {
                    this.outside && (this.container = t = f.doc.createElement("div"),
            ...
            m.prototype.getPosition = function(a, l, k) {
                var g = this.chart, d = this.distance, h = {}, f = g.inverted && k.h || 0, m, p = this.outside, B = p ? n.documentElement.clientWidth - 2 * d : g.chartWidth, M = p ? Math.max(n.body.scrollHeight, n.documentElement.scrollHeight, n.body.offsetHeight, n.documentElement.offsetHeight, n.documentElement.clientHeight) : g.chartHeight, t = g.pointer.getChartPosition(), F = g.containerScaling, e = function(b) {
                ...
                }, z = b("y"), w = b("x"), q = !this.followPointer && E(k.ttBelow, !g.inverted === !!k.negative), u = function(b, g, k, a, l, m, r) {
                    var x = "y" === b ? c(d) : e(d)
                      , w = (k - a) / 2
                      , p = a < l - d
                      , B = l + d + a < g
                    ...
                    !1 !== u.apply(0, z) ? !1 !== v.apply(0, w) || m || (I(!0),
                    H()) : m ? h.x = h.y = 0 : (I(!0),
                    H())
                };
            ...
            m.prototype.refresh = function(h, l) {
                ...
                if (g.enabled) {
                    ...
                    l = B[0];
                    var M = B[1];
                    !f || d.series && d.series.noSharedTooltip ? f = d.getLabelConfig() : (k.pointer.applyInactiveState(d),
                    ...
                    !1 === k ? this.hide() : (this.split ? this.renderSplit(k, p(h)) : (h = this.getLabel(),
                    g.style.width && !t || h.css({
            ...
            m.prototype.renderSplit = function(a, l) {
                function k(b, c, e, d, g) {
                    void 0 === g && (g = !0);
                    e ? (c = H ? 0 : G,
                    b = y(b - d / 2, n.left, n.right - d)) : (c -= K,
                    b = g ? b - d - z : b + z,
                ...
                a = a.slice(0, l.length + 1).reduce(function(e, d, a) {
                    if (!1 !== d && "" !== d) {
                        ...
                        b || (r.fill = w.backgroundColor,
                        r["stroke-width"] = w.borderWidth),
                        r = M.label("", 0, 0, w[x ? "headerShape" : "shape"] || "callout", void 0, void 0, w.useHTML).addClass((x ? "highcharts-tooltip-header " : "") + "highcharts-tooltip-box " + A).attr(r).add(I));
                        r.isActive = !0;
                        r.attr({
                            text: d
                        });
            ...
            m.prototype.drawTracker = function() {
                if (this.followPointer || !this.options.stickOnContact)
                    ...
                    if (l && k) {
                        ...
                        this.tracker ? this.tracker.attr(g) : (this.tracker = l.renderer.rect(g).addClass("highcharts-tracker").add(l),
        ...
        f = function() {
            ...
            l.prototype.drop = function(a) {
                ...
                if (this.selectionMarker) {
                    var h = {
                        ...
                        xAxis: [],
                        yAxis: []
                    }, l = this.selectionMarker, f = l.attr ? l.attr("x") : l.x, m = l.attr ? l.attr("y") : l.y, t = l.attr ? l.attr("width") : l.width, u = l.attr ? l.attr("height") : l.height, F;
            ...
            l.prototype.getHoverData = function(a, g, d, h, l, f) {
                ...
                p.forEach(function(d) {
                    ...
                    t(e) && (d.chart.isBoosting && (e = d.getPoint(e)),
                    r.push(e))
                })) : r.push(k));
                x = {
                    hoverPoint: k
            ...
            l.prototype.onTrackerMouseOut = function(a) {
                ...
                if (!(!g || !a || g.stickyTracking || this.inClass(a, "highcharts-tooltip") || this.inClass(a, "highcharts-series-" + g.index) && this.inClass(a, "highcharts-tracker")))
                    g.onMouseOut()
            }
            ;
            ...
            l.prototype.pinchTranslateDirection = function(a, g, d, h, l, f, m, p) {
                var k = this.chart, r = a ? "x" : "y", x = a ? "X" : "Y", e = "chart" + x, c = a ? "width" : "height", b = k["plot" + (a ? "Left" : "Top")], B, w, t = p || 1, A = k.inverted, u = k.bounds[a ? "h" : "v"], q = 1 === g.length, v = g[0][e], n = d[0][e], I = !q && g[1][e], N = !q && d[1][e];
                d = function() {
            ...
            l.prototype.reset = function(a, g) {
                ...
                if (a)
                    m && p && h(p).length && (m.refresh(p),
                    m.shared && f ? f.forEach(function(d) {
                        d.setState(d.state, !0);
                        d.series.isCartesian && (d.series.xAxis.crosshair && d.series.xAxis.drawCrosshair(null, d),
            ...
            l.prototype.runPointActions = function(h, g) {
                ...
                if (f && (f !== d.hoverPoint || k && k.isHidden)) {
                    ...
                    g && k && !k.isHidden && (f = k.getAnchor([{}], h),
                    k.updatePosition({
                        plotX: f[0],
                        plotY: f[1]
                    }));
                this.unDocMouseMove || (this.unDocMouseMove = J(d.container.ownerDocument, "mousemove", function(d) {
                    ...
                    if (g)
                        g.pointer.onDocumentMouseMove(d)
                }));
            ...
            l.prototype.scaleGroups = function(a, g) {
                ...
                d.series.forEach(function(k) {
                    h = a || k.getPlotBox();
                    k.xAxis && k.xAxis.zoomEnabled && k.group && (k.group.attr(h),
                    k.markerGroup && (k.markerGroup.attr(h),
            ...
            l.prototype.setDOMEvents = function() {
                ...
                a.hasTouch && (J(h, "touchstart", this.onContainerTouchStart.bind(this)),
            ...
            l.prototype.setHoverChartIndex = function() {
                ...
                if (g && g !== h)
                    g.pointer.onContainerMouseLeave({
                        relatedTarget: !0
                    });
    ...
    O(n, "Core/MSPointer.js", [n["Core/Globals.js"], n["Core/Pointer.js"], n["Core/Utilities.js"]], function(f, a, n) {
        ...
        function D(a, p, u, m) {
            "touch" !== a.pointerType && a.pointerType !== a.MSPOINTER_TYPE_TOUCH || !C[f.hoverChartIndex] || (m(a),
        ...
        var G = this && this.__extends || function() {
            ...
            return function(f, p) {
                ...
                a(f, p);
                f.prototype = null === p ? Object.create(p) : (m.prototype = p.prototype,
                new m)
            }
        }()
          , C = f.charts
          ...
          , l = function() {
            ...
            a.prototype.colorizeItem = function(a, d) {
                ...
                if (!this.chart.styledMode) {
                    ...
                    f && (p && f.isMarker && (t = a.pointAttribs(),
                    d || (t.stroke = t.fill = l)),
                    f.attr(t))
                }
            ...
            a.prototype.positionItem = function(a) {
                ...
                ,
                G(m.translateY) ? m.animate(h, void 0, k) : (m.attr(h),
                k()));
                l && (l.x = g,
                l.y = f)
            }
            ...
            a.prototype.renderItem = function(a) {
                ...
                this.baseline || (this.fontMetrics = g.fontMetrics(d.styledMode ? 12 : l.fontSize, e),
            ...
            a.prototype.layoutItem = function(a) {
                ...
                h && this.itemX - g + d > p && (this.itemX = g,
                ...
                h ? this.itemX += d : (this.itemY += l + k + f,
            ...
            a.prototype.proximatePositions = function() {
                ...
                this.allItems.forEach(function(g) {
                    ...
                    if (g.yAxis) {
                        ...
                        g.visible ? (k = k ? k.plotY : g.yAxis.height,
                        k += f - .3 * l) : k = f + g.yAxis.height;
                        d.push({
                            target: k,
                            size: l,
                            item: g
            ...
            a.prototype.handleOverflow = function(a) {
                ...
                var m = k.maxHeight, p, t = this.clipRect, e = k.navigation, c = K(e.animation, !0), b = e.arrowSize || 12, z = this.nav, w = this.pages, q, u = this.allItems, n = function(b) {
                    "number" === typeof b ? t.attr({
                        height: b
                    }) : t && (d.clipRect = t.destroy(),
                    d.contentGroup.clip());
                ...
                m && (l = Math.min(l, m));
                w.length = 0;
                a > l && !1 !== e.enabled ? (this.clipHeight = p = Math.max(l - 20 - this.titleHeight - f, 0),
                ...
                u.forEach(function(b, c) {
                    ...
                    b.pageIx = a - 1;
                    q && (u[c - 1].pageIx = a - 1);
                    c === u.length - 1 && e + d - w[a - 1] > p && e !== q && (w.push(e),
                    b.pageIx = a);
                    e !== q && (q = e)
                }),
                t || (t = d.clipRect = h.clipRect(0, f, 9999, 0),
                d.contentGroup.clip(t)),
                n(p),
                z || (this.nav = z = h.g().attr({
                    zIndex: 1
                }).add(this.group),
        ...
        var H = a.charts
          ...
          , Y = function() {
            ...
            D.prototype.getArgs = function(b, c, e) {
                F(b) || b.nodeName ? (this.renderTo = b,
                this.init(c, e)) : this.init(b, c)
            }
            ;
            ...
            D.prototype.redraw = function(b) {
                ...
                a.forEach(function(b) {
                    ...
                    l = !0) : k && (k.labelFormatter || k.labelFormat) && (l = !0));
                    b.isDirtyData && r(b, "updatedData")
                });
                l && h && h.options.enabled && (h.render(),
                c.isDirtyLegend = !1);
                B && c.getStacks();
                f && e.forEach(function(b) {
                    c.isResizing && M(b.min) || (b.updateNames(),
                    b.setScale())
                });
                c.getMargins();
                f && (e.forEach(function(b) {
            ...
            D.prototype.layOutTitles = function(b) {
                ...
                !this.isDirtyBox && g && (this.isDirtyBox = this.isDirtyLegend = g,
            ...
            D.prototype.temporaryDisplay = function(b) {
                ...
                if (b)
                    for (; c && c.style; )
                        c.hcOrigStyle && (m(c, c.hcOrigStyle),
                        delete c.hcOrigStyle),
                        c.hcOrigDetached && (v.body.removeChild(c),
                        c.hcOrigDetached = !1),
                        c = c.parentNode;
                else
                    for (; c && c.style; ) {
                        v.body.contains(c) || c.parentNode || (c.hcOrigDetached = !0,
            ...
            D.prototype.setChartSize = function(b) {
                var c = this.inverted, e = this.renderer, d = this.chartWidth, a = this.chartHeight, g = this.options.chart, h = this.spacing, k = this.clipOffset, f, l, m, p;
            ...
            D.prototype.drawChartBox = function() {
                ...
                a || (this.chartBackground = a = c.rect().addClass("highcharts-background").add(),
                F = "attr");
                if (k)
                    var n = w = a.strokeWidth();
                else {
                    n = b.borderWidth || 0;
                    w = n + (b.shadow ? 8 : 0);
                    l = {
                ...
                p && (f ? (p !== f.attr("href") && f.attr("href", p),
                f.animate(x)) : this.plotBGImage = c.image(p, z, t, B, q).add()));
                u ? u.animate({
                    width: A.width,
                    height: A.height
                ...
                F = "animate";
                h || (F = "attr",
                this.plotBorder = h = c.rect().addClass("highcharts-plot-border").attr({
                    zIndex: 1
                }).add());
                k || h.attr({
            ...
            D.prototype.linkSeries = function() {
                ...
                c.forEach(function(c) {
                    ...
                    F(e) && (e = ":previous" === e ? b.series[c.index - 1] : b.get(e)) && e.linkedParent !== c && (e.linkedSeries.push(c),
                    c.linkedParent = e,
    ...
    O(n, "Extensions/ScrollablePlotArea.js", [n["Core/Chart/Chart.js"], n["Core/Globals.js"], n["Core/Utilities.js"]], function(f, a, n) {
            ...
            if (!this.renderer.forExport) {
                if (v) {
                    if (this.scrollablePixelsX = v = Math.max(0, v - this.chartWidth)) {
                        this.plotWidth += v;
                        this.inverted ? (this.clipBox.height += v,
                        this.plotBox.height += v) : (this.clipBox.width += v,
                    ...
                    n && (this.scrollablePixelsY = v = Math.max(0, n - this.chartHeight)) && (this.plotHeight += v,
                    this.inverted ? (this.clipBox.width += v,
                    this.plotBox.width += v) : (this.clipBox.height += v,
        ...
        f.prototype.applyFixed = function() {
            ...
            v && (L.scrollPositionX && (this.scrollingContainer.scrollLeft = this.scrollablePixelsX * L.scrollPositionX),
          ...
          , J = function() {
            ...
            a.prototype.resetStacks = function() {
                ...
                a.axis.isXAxis || G(f, function(f) {
                    G(f, function(q, n) {
                        q.touched < a.stacksTouched ? (q.destroy(),
                        delete f[n]) : (q.total = null,
                        q.cumulative = null)
                    })
                })
            }
    ...
    O(n, "Mixins/LegendSymbol.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function(f, a) {
        ...
        return f.LegendSymbolMixin = {
            ...
            drawLineMarker: function(a) {
                ...
                C && !1 !== C.enabled && D && (f = Math.min(y(C.radius, v), v),
                0 === this.symbol.indexOf("url") && (C = n(C, {
                    width: H,
                    height: H
                }),
                f = 0),
                this.legendSymbol = C = L.symbol(this.symbol, D / 2 - f, a - f, 2 * f, 2 * f, C).addClass("highcharts-point").add(q),
                C.isMarker = !0)
            }
        }
    });
    O(n, "Core/Series/Point.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function(f, a) {
        ...
        a = function() {
            ...
            a.prototype.destroy = function() {
                ...
                if (f === l.hoverPoint)
                    f.onMouseOut();
                h && h.enabled ? (this.animateBeforeDestroy(),
                K(a, g.duration)) : a();
                l.pointCount--
            }
            ;
            ...
            a.prototype.optionsToObject = function(f) {
                ...
                if (L(f) || null === f)
                    ...
                    for (!l && f.length > g && (h = typeof f[0],
                    "string" === h ? m.name = f[0] : "number" === h && (m.x = f[0]),
                    d++); p < g; )
                        l && "undefined" === typeof f[d] || (0 < k[p].indexOf(".") ? a.prototype.setNestedProperty(m, f[d], k[p]) : m[k[p]] = f[d]),
                        d++,
                        p++;
                else
                    "object" === typeof f && (m = f,
            ...
            a.prototype.resolveColor = function() {
                ...
                a.options.colorByPoint ? (h || (f = a.options.colors || a.chart.options.colors,
                this.color = this.color || f[a.colorCounter],
                f = f.length),
                h = a.colorCounter,
                a.colorCounter++,
                a.colorCounter === f && (a.colorCounter = 0)) : h = a.colorIndex;
    ...
    O(n, "Core/Series/Series.js", [n["Core/Globals.js"], n["Mixins/LegendSymbol.js"], n["Core/Options.js"], n["Core/Series/Point.js"], n["Core/Renderer/SVG/SVGElement.js"], n["Core/Utilities.js"]], function(f, a, n, y, D, G) {
        ...
        f.Series = n("line", null, {
            ...
            init: function(e, c) {
                ...
                var g = c.events;
                r(g, function(c, e) {
                    k(c) && b.eventOptions[e] !== c && (k(b.eventOptions[e]) && N(b, e, b.eventOptions[e]),
                    b.eventOptions[e] = c,
                    J(b, e, c))
                });
                ...
                m(this, "bindAxes", null, function() {
                    (e.axisTypes || []).forEach(function(d) {
                        b[d].forEach(function(b) {
                            a = b.options;
                            if (c[d] === a.index || "undefined" !== typeof c[d] && c[d] === a.id || "undefined" === typeof c[d] && 0 === a.index)
                                e.insert(b.series),
                                e[d] = b,
                                b.isDirty = !0
                        });
            ...
            updateData: function(e, c) {
                var b = this.options, a = b.dataSorting, d = this.points, h = [], f, k, l, m = this.requireSorting, p = e.length === d.length, r = !0;
                ...
                e.forEach(function(c, e) {
                    ...
                    var w = k.x;
                    if (k.id || g(w)) {
                        if (w = this.findPointIndex(k, l),
                        -1 === w || "undefined" === typeof w ? h.push(c) : d[w] && c !== b.data[w] ? (d[w].update(c, !1, null, !1),
                        d[w].touched = !0,
                        m && (l = w + 1)) : d[w] && (d[w].touched = !0),
                ...
                if (f)
                    ...
                    !p || a && a.enabled ? r = !1 : (e.forEach(function(b, c) {
                ...
                null === this.xIncrement && this.xData && this.xData.length && (this.xIncrement = v(this.xData),
                this.autoIncrement());
                return !0
            },
            setData: function(e, c, b, a) {
                var h = this, f = h.points, k = f && f.length || 0, m, p = h.options, r = h.chart, B = p.dataSorting, z = null, n = h.xAxis;
                z = p.turboThreshold;
            ...
            getProcessedData: function(e) {
                ...
                for (f = c.length || 1; --f; )
                    if (a = h ? e(c[f]) - e(c[f - 1]) : c[f] - c[f - 1],
                    0 < a && ("undefined" === typeof n || a < n))
                        var n = a;
                    else
                        0 > a && m && (t(15, !1, this.chart),
                        m = !1);
                return {
                    xData: c,
                    yData: b,
            ...
            generatePoints: function() {
                var e = this.options, c = e.data, b = this.data, a, d = this.processedXData, g = this.processedYData, h = this.pointClass, f = d.length, k = this.cropStart || 0, l = this.hasGroupedData;
                e = e.keys;
                var p = [], r;
                b || l || (b = [],
                b.length = c.length,
                ...
                for (r = 0; r < f; r++) {
                    ...
                    if (l) {
                        ...
                        n.dataGroup.options && (n.options = n.dataGroup.options,
                        I(n, n.dataGroup.options),
                        delete n.dataLabels)
                    } else
                        (n = b[t]) || "undefined" === typeof c[t] || (b[t] = n = (new h).init(this, c[t], d[r]));
                    n && (n.index = t,
                    p[r] = n)
                }
                this.options.keys = e;
            ...
            getExtremes: function(e, c) {
                var b = this.xAxis
                  ...
                  , k = 0;
                var p = 0;
                var r = this.requireSorting ? this.cropShoulder : 0, t = a ? a.positiveValuesOnly : !1, B;
            ...
            translate: function() {
                ...
                this.generatePoints();
                var e = this.options, c = e.stacking, b = this.xAxis, a = b.categories, d = this.enabledDataSorting, h = this.yAxis, f = this.points, k = f.length, p = !!this.modifyValue, r, t = this.pointPlacementToXValue(), B = !!t, n = e.threshold, x = e.startFromThreshold ? n : 0, F, M = this.zoneAxis || "y", v = Number.MAX_VALUE;
                for (r = 0; r < k; r++) {
                    var u = f[r]
                      , I = u.x
                      , C = u.y
                    ...
                    if (h.positiveValuesOnly && !h.validatePositiveValue(C) || b.positiveValuesOnly && !b.validatePositiveValue(I))
                        u.isNull = !0;
            ...
            setClip: function(e) {
                ...
                k ? c.hasLoaded || k.attr(h) : (e && (c[f + "m"] = l = a.clipRect(d ? c.plotSizeX + 99 : -99, d ? -c.plotLeft : -c.plotTop, 99, d ? c.chartWidth : c.chartHeight)),
                c[f] = k = a.clipRect(h),
                k.count = {
                    length: 0
                });
                e && !k.count[this.index] && (k.count[this.index] = !0,
                k.count.length += 1);
                if (!1 !== b.clip || e)
                    this.group.clip(e || g ? k : c.clipRect),
                    this.markerGroup.clip(l),
                    this.sharedClipKey = f;
                e || (k.count[this.index] && (delete k.count[this.index],
                --k.count.length),
                0 === k.count.length && f && c[f] && (g || (c[f] = c[f].destroy()),
            ...
            drawPoints: function() {
                var e = this.points, c = this.chart, b, a, d = this.options.marker, g = this[this.specialGroup] || this.markerGroup, h = this.xAxis, f = A(d.enabled, !h || h.isRadial ? !0 : null, this.closestPointRangePx >= d.enabledThreshold * d.radius);
                if (!1 !== d.enabled || this._hasPointMarkers)
                    for (b = 0; b < e.length; b++) {
                        ...
                        if ((f && "undefined" === typeof m.enabled || m.enabled) && !k.isNull && !1 !== k.visible) {
                            ...
                            var B = !1 !== k.isInside;
                            a ? a[B ? "show" : "hide"](B).animate(t) : B && (0 < t.width || k.hasImage) && (k.graphic = a = c.renderer.symbol(r, t.x, t.y, t.width, t.height, p ? m : d).add(g),
                            this.enabledDataSorting && c.hasRendered && (a.attr({
                                x: k.startXPos
                            }),
                            l = "animate"));
            ...
            destroy: function(e) {
                var c = this, b = c.chart, a = /AppleWebKit\/533/.test(F.navigator.userAgent), d, g, h = c.data || [], f, k;
                m(c, "destroy");
                this.removeEvents(e);
                (c.axisTypes || []).forEach(function(b) {
                    (k = c[b]) && k.series && (p(k.series, c),
                ...
                r(c, function(b, c) {
                    b instanceof D && !b.survive && (d = a && "group" === c ? "hide" : "destroy",
                    b[d]())
                });
            ...
            getGraphPath: function(e, c, b) {
                ...
                e.forEach(function(h, m) {
                    ...
                    h.isNull && !E(c) && 0 < m ? l = !d.connectNulls : h.isNull && !c ? l = !0 : (0 === m || l ? m = [["M", h.plotX, h.plotY]] : a.getPointSpline ? m = [a.getPointSpline(e, h, m)] : g ? (m = 1 === g ? [["L", t.plotX, r]] : 2 === g ? [["L", (t.plotX + p) / 2, t.plotY], ["L", (t.plotX + p) / 2, r]] : [["L", p, t.plotY]],
                    m.push(["L", p, r])) : m = [["L", p, r]],
                    k.push(h.x),
                    g && (k.push(h.x),
                    2 === g && k.push(h.x)),
                    f.push.apply(f, m),
            ...
            drawGraph: function() {
                ...
                d.forEach(function(d, g) {
                    var h = d[0]
                      , f = e[h]
                      , k = f ? "animate" : "attr";
                    f ? (f.endX = e.preventGraphAnimation ? null : b.xMap,
                    f.animate({
                        d: b
            ...
            applyZones: function() {
                var a = this, c = this.chart, b = c.renderer, d = this.zones, g, h, f = this.clips || [], k, l = this.graph, m = this.area, p = Math.max(c.chartWidth, c.chartHeight), r = this[(this.zoneAxis || "y") + "Axis"], t = c.inverted, B, n, x, F = !1, u, M;
            ...
            invertGroups: function(a) {
                ...
                var b = this
                  , e = b.chart;
                b.xAxis && (b.eventsToUnbind.push(J(e, "resize", c)),
                c(),
                b.invertGroups = c)
            },
            ...
            searchKDTree: function(a, c, b) {
                function d(b, c, a, k) {
                    ...
                    c[t] && (t = d(b, c[t], a + 1, k),
                    p = t[f] < p[f] ? t : l);
                    c[r] && Math.sqrt(m * m) < p[f] && (b = d(b, c[r], a + 1, k),
                    p = b[f] < p[f] ? b : p);
                    return p
                }
                var e = this
    ...
    O(n, "Extensions/Stacking.js", [n["Core/Axis/Axis.js"], n["Core/Chart/Chart.js"], n["Core/Globals.js"], n["Core/Axis/StackingAxis.js"], n["Core/Utilities.js"]], function(f, a, n, y, D) {
        ...
        var q = n.Series
          , K = function() {
            ...
            a.prototype.render = function(a) {
                ...
                f.styledMode || (n.fill = p.backgroundColor,
            ...
            a.prototype.setOffset = function(a, f, n, u, m) {
                ...
                l.isInsidePlot(f.alignAttr.x + k - this.alignOptions.x, f.alignAttr.y + n - this.alignOptions.y) ? f.show() : (f.alignAttr.y = -9999,
                a = !1),
        ...
        q.prototype.setStackedPoints = function(a) {
            ...
            if (f && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                ...
                var g = "-" + a, d = this.negStacks, x = this.yAxis, r = x.stacking.stacks, A = x.stacking.oldStacks, v, B;
                ...
                for (B = 0; B < m; B++) {
                    ...
                    r[c] || (r[c] = {});
                    r[c][M] || (A[c] && A[c][M] ? (r[c][M] = A[c][M],
                    r[c][M].total = null) : r[c][M] = new K(x,x.options.stackLabels,v,M,h));
                    c = r[c][M];
                    null !== E ? (c.points[e] = c.points[this.index] = [L(c.cumulative, k)],
                    C(c.cumulative) || (c.base = e),
                    c.touched = x.stacking.stacksTouched,
                    0 < F.index && !1 === this.singleStacks && (c.points[e][0] = c.points[this.index + "," + M + ",0"][0])) : c.points[e] = c.points[this.index] = null;
                    "percent" === f ? (v = v ? a : g,
                    d && r[v] && r[v][M] ? (v = r[v][M],
                    c.total = v.total = Math.max(v.total, c.total) + Math.abs(E) || 0) : c.total = G(c.total + (Math.abs(E) || 0))) : "group" === f ? null !== E && (c.total = (c.total || 0) + 1) : c.total = G(c.total + (E || 0));
                    c.cumulative = "group" === f ? (c.total || 1) - 1 : L(c.cumulative, k) + (E || 0);
                    null !== E && (c.points[e].push(c.cumulative),
                    u[B] = c.cumulative,
                    c.hasValidPoints = !0)
                }
    ...
    O(n, "Core/Dynamics.js", [n["Core/Axis/Axis.js"], n["Core/Chart/Chart.js"], n["Core/Globals.js"], n["Core/Options.js"], n["Core/Series/Point.js"], n["Core/Time.js"], n["Core/Utilities.js"]], function(f, a, n, y, D, G, C) {
        ...
        t(a.prototype, {
            ...
            update: function(a, h, f, p) {
                var e = this, c = {
                    ...
                    subtitle: "setSubtitle",
                    caption: "setCaption"
                }, b, r, q, t = a.isResponsiveOptions, B = [];
                I(e, "update", {
                    options: a
                });
        ...
        t(D.prototype, {
            update: function(a, g, f, k) {
                function e() {
                    ...
                    e = null === c.y ? !e : e;
                    l && e && (c.graphic = l.destroy(),
                    delete c.hasDummyGraphic);
                    h(a, !0) && (l && l.element && a && a.marker && "undefined" !== typeof a.marker.symbol && (c.graphic = l.destroy()),
        ...
        t(y.prototype, {
            addPoint: function(a, g, h, f, e) {
                ...
                l && n.name && (l[q] = n.name);
                m.splice(t, 0, a);
                r && (this.data.splice(t, 0, null),
                this.processData());
                "point" === c.legendType && this.generatePoints();
                h && (b[0] && b[0].remove ? b[0].remove(!1) : (b.shift(),
            ...
            update: function(a, g) {
                ...
                var h = this, f = h.chart, e = h.userOptions, c = h.initialType || h.type, b = a.type || e.type || f.options.chart.type, l = !(this.hasDerivedData || a.dataGrouping || b && b !== this.type || "undefined" !== typeof a.pointStart || a.pointInterval || a.pointIntervalUnit || a.keys), m = N[c].prototype, r, q = ["eventOptions", "navigatorSeries", "baseSeries"], x = h.finishedAnimating && {
                    animation: !1
                }, B = {};
                l && (q.push("data", "isDirtyData", "points", "processedXData", "processedYData", "xIncrement", "cropped", "_hasPointMarkers", "_hasPointLabels", "mapMap", "mapData", "minY", "maxY", "minX", "maxX"),
                !1 !== a.visible && q.push("area", "graph"),
                h.parallelArrays.forEach(function(b) {
                    q.push(b + "Data")
                }),
                a.data && (a.dataSorting && t(h.options.dataSorting, a.dataSorting),
                ...
                if (l && this.points) {
                    var A = h.options;
                    !1 === A.visible ? (B.graphic = 1,
                    B.dataLabel = 1) : h._hasPointLabels || (a = A.marker,
                    e = A.dataLabels,
    ...
    O(n, "Series/AreaSeries.js", [n["Core/Globals.js"], n["Core/Color.js"], n["Mixins/LegendSymbol.js"], n["Core/Utilities.js"]], function(f, a, n, y) {
        ...
        a("area", "line", {
            ...
            getStackPoints: function(a) {
                var f = [], n = [], q = this.xAxis, H = this.yAxis, E = H.stacking.stacks[this.stackKey], p = {}, t = this.index, I = H.series, u = I.length, m = C(H.options.reversedStacks, !0) ? 1 : -1, h;
                a = a || this.points;
            ...
            getGraphPath: function(a) {
                var f = J.prototype.getGraphPath, n = this.options, q = n.stacking, y = this.yAxis, E, p = [], t = [], I = this.index, u = y.stacking.stacks[this.stackKey], m = n.threshold, h = Math.round(y.getThreshold(n.threshold));
            ...
            drawGraph: function() {
                ...
                q.forEach(function(q) {
                    var v = q[0]
                      ...
                      , t = p ? "animate" : "attr"
                      , I = {};
                    p ? (p.endX = a.preventGraphAnimation ? null : f.xMap,
                    p.animate({
                        d: f
                    })) : (I.zIndex = 0,
        ...
        f("spline", "line", {}, {
            getPointSpline: function(f, n, D) {
                ...
                if (J && !J.isNull && !1 !== J.doCurve && !n.isCliff && D && !D.isNull && !1 !== D.doCurve && !n.isCliff) {
                    ...
                    q += v;
                    K += v;
                    q > f && q > C ? (q = Math.max(f, C),
                    K = 2 * C - q) : q < f && q < C && (q = Math.min(f, C),
                    K = 2 * C - q);
                    K > D && K > C ? (K = Math.max(D, C),
                    q = 2 * C - K) : K < D && K < C && (K = Math.min(D, C),
                    q = 2 * C - K);
                    n.rightContX = H;
                    n.rightContY = K
                }
    ...
    O(n, "Series/ColumnSeries.js", [n["Core/Globals.js"], n["Core/Color.js"], n["Mixins/LegendSymbol.js"], n["Core/Utilities.js"]], function(f, a, n, y) {
        ...
        a("column", "line", {
            ...
            crispCol: function(a, f, n, q) {
                ...
                this.options.crisp && (n = Math.round(a + n) + l,
                a = Math.round(a) + l,
                n -= a);
                q = Math.round(f + q) + h;
                l = .5 >= Math.abs(f) && .5 < q;
                    ...
                    K(this.yAxis.stacking && this.yAxis.stacking.stacks, function(a) {
                        if ("number" === typeof q.x && (a = a[q.x.toString()])) {
                            var d = a.points[m.index]
                              , g = a.total;
                            h ? (d && (l = k),
                            a.hasValidPoints && k++) : f.isArray(d) && (l = d[1],
                            k = g || 0)
                        }
                    });
            ...
            translate: function() {
                ...
                a.points.forEach(function(p) {
                    ...
                    J(p.options.pointWidth) && (e = u = Math.ceil(p.options.pointWidth),
                    b -= Math.round((e - x) / 2));
            ...
            pointAttribs: function(a, f) {
                ...
                f && a && (a = L(p.states[f], a.options.states && a.options.states[f] || {}),
                f = a.brightness,
        ...
        p("pie", "line", {
            ...
            redrawPoints: function() {
                ...
                a.points.forEach(function(h) {
                    ...
                    if (!h.isNull && g) {
                        ...
                        h.delayedRendering ? (g.setRadialReference(a.center).attr(n).attr(k),
                        f.styledMode || g.attr(d).attr({
                            "stroke-linejoin": "round"
                        }).shadow(p, r),
                        h.delayedRendering = !1) : (g.setRadialReference(a.center),
            ...
            drawPoints: function() {
                ...
                this.points.forEach(function(f) {
                    ...
                    f.graphic || (f.graphic = a[f.shapeType](f.shapeArgs).add(f.series.group),
            ...
            setVisible: function(a, f) {
                ...
                f = K(f, d);
                a !== h.visible && (h.visible = h.options.visible = a = "undefined" === typeof a ? !h.visible : a,
    ...
    O(n, "Core/Series/DataLabels.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function(f, a) {
            ...
            a.some(function(a) {
                ...
                if (a.targets.some(function() {
                    ...
                    if ("undefined" !== typeof k && Math.abs(m[d].pos - m[d].target) > k)
                        return m.slice(0, d + 1).forEach(function(a) {
                            delete a.pos
                        }),
                        m.reducedLen = (m.reducedLen || l) - .1 * l,
                        m.reducedLen > .1 * l && f.distribute(m, l, k),
                        !0;
                    g += m[d].size;
                    d++
                }))
        ...
        m.prototype.drawDataLabels = function() {
            ...
            var k = this, g = k.chart, d = k.options, m = d.dataLabels, n = k.points, t, u = k.hasRendered || 0, B = m.animation;
            B = m.defer ? L(g, B, k) : {
                defer: 0,
                duration: 0
            };
            ...
            if (q(m) || m.enabled || k._hasPointLabels) {
                ...
                !u && (u = k.dataLabelsGroup) && (k.visible && D.show(!0),
                ...
                n.forEach(function(h) {
                    ...
                    t.forEach(function(e, c) {
                        ...
                        if (b) {
                            ...
                            q = e.style;
                            var t = e.rotation;
                            g.styledMode || (q.color = p(e.color, q.color, k.color, "#000000"),
                            "contrast" === q.color ? (h.contrastColor = y.getContrast(h.color || k.color),
                            q.color = !C(m) && e.inside || 0 > m || d.stacking ? h.contrastColor : "#000000") : delete h.contrastColor,
                            ...
                            g.styledMode || (x.fill = e.backgroundColor,
                        ...
                        !f || b && C(r) ? b && C(r) && (f ? x.text = r : (h.dataLabels = h.dataLabels || [],
                        ...
                        f.added || f.add(D),
                        e.textPath && !e.useHTML && (f.setTextPath(h.getDataLabelPath && h.getDataLabelPath(f) || h.graphic, e.textPath),
                        h.dataLabelPath && !e.textPath.enabled && (h.dataLabelPath = h.dataLabelPath.destroy())),
                        k.alignDataLabel(h, f, e, null, n)) : (h.dataLabel = h.dataLabel && h.dataLabel.destroy(),
                        h.dataLabels && (1 === h.dataLabels.length ? delete h.dataLabels : delete h.dataLabels[c]),
                        c || delete h.dataLabel,
                        l && (h.connector = h.connector.destroy(),
        ...
        m.prototype.alignDataLabel = function(a, f, k, g, d) {
            ...
            if (z) {
                ...
                w(q),
                f[d ? "attr" : "animate"](q).attr({
                    align: e
                }),
                w = (u + 720) % 360,
                w = 180 < w && 360 > w,
                "left" === e ? q.y -= w ? v.height : 0 : "center" === e ? (q.x -= v.width / 2,
                q.y -= v.height / 2) : "right" === e && (q.x -= v.width,
                q.y -= w ? 0 : v.height),
                f.placed = !0,
                f.alignAttr = q) : (w(g),
                f.align(k, null, g),
        ...
        m.prototype.justifyDataLabel = function(a, f, k, g, d, m) {
            ...
            t = k.x + p;
            if (0 > t) {
                "right" === l && 0 <= q ? (f.align = "left",
                f.inside = !0) : q -= t;
                var e = !0
            }
            t = k.x + g.width - p;
            t > h.plotWidth && ("left" === l && 0 >= q ? (f.align = "right",
            f.inside = !0) : q += h.plotWidth - t,
            e = !0);
            t = k.y + p;
            0 > t && ("bottom" === n && 0 <= x ? (f.verticalAlign = "top",
            f.inside = !0) : x -= t,
            e = !0);
            t = k.y + g.height - p;
            t > h.plotHeight && ("top" === n && 0 >= x ? (f.verticalAlign = "bottom",
            f.inside = !0) : x += h.plotHeight - t,
            e = !0);
            e && (f.x = q,
            f.y = x,
            a.placed = !m,
        ...
        y.pie.prototype.drawDataLabels = function() {
            var a = this, l = a.data, k, g = a.chart, d = a.options.dataLabels || {}, n = d.connectorPadding, r, q = g.plotWidth, t = g.plotHeight, v = g.plotLeft, u = Math.round(g.chartWidth / 3), y, F = a.center, e = F[2] / 2, c = F[1], b, z, w, E, H = [[], []], G, I, J, L, O = [0, 0, 0, 0], S = a.dataLabelPositioners, V;
            ...
            l.forEach(function(a) {
                a.dataLabel && (a.visible ? (H[a.half].push(a),
                a.dataLabel._pos = null,
                !C(d.style.width) && !C(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) && a.dataLabel.getBBox().width > u && (a.dataLabel.css({
                ...
                if (m) {
                    ...
                    if (0 < a.maxLabelDistance) {
                        ...
                        h.forEach(function(a) {
                            0 < a.labelDistance && a.dataLabel && (a.top = Math.max(0, c - e - a.labelDistance),
                    ...
                    for (L = 0; L < m; L++) {
                        ...
                        I = u = w.natural.y;
                        r && C(k.distributeBox) && ("undefined" === typeof k.distributeBox.pos ? J = "hidden" : (E = k.distributeBox.size,
                        ...
                        w.final.x = G;
                        w.final.y = I;
                        p(d.crop, !0) && (z = b.getBBox().width,
                        u = null,
                        G - z < n && 1 === l ? (u = Math.round(z - G + n),
                        O[3] = Math.max(u, O[3])) : G + z > q - n && 0 === l && (u = Math.round(G + z - q + n),
                        O[1] = Math.max(u, O[1])),
            ...
            this.points.forEach(function(c) {
                ...
                if (r = p(V.connectorWidth, 1)) {
                    ...
                    if ((b = c.dataLabel) && b._pos && c.visible && 0 < c.labelDistance) {
                        ...
                        if (e = !y)
                            c.connector = y = g.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + c.colorIndex + (c.className ? " " + c.className : "")).add(a.dataLabelsGroup),
                            g.styledMode || y.attr({
                                "stroke-width": r,
        ...
        y.pie.prototype.placeDataLabels = function() {
            this.points.forEach(function(a) {
                var f = a.dataLabel, h;
                f && a.visible && ((h = f._pos) ? (f.sideOverflow && (f._attr.width = Math.max(f.getBBox().width - f.sideOverflow, 0),
                f.css({
        ...
        y.pie.prototype.verifyDataLabelOverflow = function(a) {
            ...
            if (!m) {
                if (null !== g[0])
                    ...
                    f[0] += (a[3] - a[1]) / 2;
                null !== g[1] ? n = G(n, d, f[2] - Math.max(a[0], a[2])) : (n = G(n, d, f[2] - a[0] - a[2]),
                f[1] += (a[0] - a[2]) / 2);
                n < f[2] ? (f[2] = n,
    ...
    O(n, "Extensions/OverlappingDataLabels.js", [n["Core/Chart/Chart.js"], n["Core/Utilities.js"]], function(f, a) {
        ...
        f.prototype.hideOverlappingLabels = function(a) {
            ...
            a.forEach(function(a) {
                if (a) {
                    var h = a.newOpacity;
                    a.oldOpacity !== h && (a.alignAttr && a.placed ? (a[h ? "removeClass" : "addClass"]("highcharts-data-label-hidden"),
                    t = !0,
    ...
    O(n, "Core/Interaction.js", [n["Core/Chart/Chart.js"], n["Core/Globals.js"], n["Core/Legend.js"], n["Core/Options.js"], n["Core/Series/Point.js"], n["Core/Utilities.js"]], function(f, a, n, y, D, G) {
        ...
        var g = a.TrackerMixin = {
            drawTrackerPoint: function() {
                var a = this, f = a.chart, g = f.pointer, h = function(a) {
                    ...
                    "undefined" !== typeof d && (g.isDirectTouch = !0,
                    d.onMouseOver(a))
                }, k;
            ...
            drawTrackerGraph: function() {
                ...
                t ? t.attr({
                    ...
                    zIndex: 2
                }).addClass(g ? "highcharts-tracker-area" : "highcharts-tracker-line").add(a.group),
                m.styledMode || a.tracker.attr({
        ...
        q(f.prototype, {
            ...
            zoom: function(a) {
                ...
                g.initiated = !1) : a.xAxis.concat(a.yAxis).forEach(function(a) {
                    ...
                    if (!b && l >= e && l <= c || b || !L(l))
                        m = !0;
                    g[b ? "zoomX" : "zoomY"] && m && (f = h.zoom(a.min, a.max),
                    h.displayBtn && (k = !0))
                });
            ...
            pan: function(d, f) {
                var g = this, h = g.hoverPoints, k = g.options.chart, l = g.options.mapNavigation && g.options.mapNavigation.enabled, m;
                f = "object" === typeof f ? f : {
                    enabled: f,
                    type: "x"
                };
                    ...
                    f.forEach(function(e) {
                        ...
                        c.series.forEach(function(a) {
                            if (v && !e && (!x || x.isDirty)) {
                                ...
                                t(a.dataMin) && t(a.dataMax) && (x.startMin = Math.min(a.dataMin, x.startMin),
                        ...
                        0 < u && (r = k,
                        h -= u),
                        c.series.length && h !== q.min && r !== q.max && h >= p && r <= k && (c.setExtremes(h, r, !1, !1, {
                            trigger: "pan"
                        }),
                        g.resetZoomButton || l || h === p || r === k || !n.match("y") || (g.showResetZoom(),
                        c.displayBtn = !1),
                        m = !0),
                        g[b] = f)
                    });
        ...
        q(D.prototype, {
            ...
            setState: function(a, f) {
                var d = this.series, g = this.state, k = d.options.states[a || "normal"] || {}, l = C.plotOptions[d.type].marker && d.options.marker, m = l && !1 === l.enabled, n = l && l.states && l.states[a || "normal"] || {}, p = !1 === n.enabled, e = d.stateMarkerGraphic, c = this.marker || {}, b = d.chart, t = d.halo, u, v = l && d.markerAttribs;
                a = a || "";
                if (!(a === this.state && !f || this.selected && "select" !== a || !1 === k.enabled || a && (p || m && !1 === n.enabled) || a && c.states && c.states[a] && !1 === c.states[a].enabled)) {
                        ...
                        if (a && n) {
                            ...
                            if (u)
                                if (e)
                                    ...
                                    g && (d.stateMarkerGraphic = e = b.renderer.symbol(g, u.x, u.y, u.width, u.height).add(d.markerGroup),
                                    e.currentSymbol = g);
                    ...
                    a && a.size && e && "hidden" !== k && !this.isCluster ? (t || (d.halo = t = b.renderer.path().add(e.parentGroup)),
                    t.show()[f ? "animate" : "attr"]({
        ...
        q(y.prototype, {
            ...
            setState: function(a, f) {
                ...
                if (d.state !== a && ([d.group, d.markerGroup, d.dataLabelsGroup].forEach(function(c) {
                    c && (d.state && c.removeClass("highcharts-series-" + d.state),
            ...
            setVisible: function(a, f) {
                ...
                if (g.hoverSeries === d || (g.hoverPoint && g.hoverPoint.series) === d)
                    d.onMouseOut();
    ...
    O(n, "Core/Responsive.js", [n["Core/Chart/Chart.js"], n["Core/Utilities.js"]], function(f, a) {
        ...
        f.prototype.setResponsive = function(a, f) {
            ...
            y = y.toString() || void 0;
            y !== (p && p.ruleIds) && (p && this.update(p.undoOptions, a, !0),
            y ? (p = this.currentOptions(f),
            ...
            function f(a, q, v, u) {
                ...
                C(a, function(a, l) {
                    if (!u && -1 < n.collectionsWithUpdate.indexOf(l))
                        for (a = H(a),
                        v[l] = [],
                        m = 0; m < Math.max(a.length, q[l].length); m++)
                            q[l][m] && (void 0 === a[m] ? v[l][m] = q[l][m] : (v[l][m] = {},
                            f(a[m], q[l][m], v[l][m], u + 1)));
                    else
                        D(a) ? (v[l] = y(a) ? [] : {},
                        f(a, q[l] || {}, v[l], u + 1)) : v[l] = "undefined" === typeof q[l] ? null : q[l]
                })
            }
            var n = this
              , v = {};
