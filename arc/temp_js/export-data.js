...
(function(a) {
    ...
    module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/export-data", ["highcharts", "highcharts/modules/exporting"], function(g) {
        a(g);
        a.Highcharts = g;
        return a
    ...
    g(a, "Extensions/ExportData.js", [a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/Globals.js"], a["Core/Utilities.js"], a["Extensions/DownloadURL.js"]], function(a, d, e, c, g) {
        function u(a, d) {
            ...
            try {
                ...
                if (!f)
                    return c.createObjectURL(new p.Blob(["\ufeff" + a],{
                        type: d
                    }))
            } catch (M) {}
        }
        ...
        c({
            ...
            lang: {
                downloadCSV: "Unduh Versi CSV",
                downloadXLS: "Unduh Versi XLS",
                exportData: {
        ...
        d.prototype.getDataRows = function(b) {
            var d = this.hasParallelCoordinates, f = this.time, c = this.options.exporting && this.options.exporting.csv || {}, e = this.xAxis, q = {}, g = [], p = [], n = [], r;
            ...
            this.series.forEach(function(a) {
                var x = a.xAxis, l = a.options.keys || y(a, x), g = l.length, m = !a.requireSorting && {}, C = e.indexOf(x), A = H(a, l), k;
                if (!1 !== a.options.includeInDataExport && !a.options.isInternal && !1 !== a.visible) {
                    ...
                    a.options.data.forEach(function(b, h) {
                        ...
                        k = 0;
                        if (!x || "name" === a.exportKey || !d && x && x.hasNames && e)
                            b = e;
                        m && (m[b] && (b += "|" + h),
                        m[b] = !0);
                        q[b] || (q[b] = [],
                        ...
                        for (q[b].xValues[C] = y.x; k < g; )
                            h = l[k],
                            e = y[h],
                            q[b][z + k] = w(A.categoryMap[h][e], A.dateTimeValueAxisMap[h] ? f.dateFormat(c.dateFormat, e) : null, e),
                            k++
                    });
                    z += k
                }
            ...
            for (z = h.length; z--; ) {
                ...
                g.forEach(function(a) {
                    var b = a.name;
                    B && !I(b) && (B.dateTime ? (a.x instanceof Date && (a.x = a.x.getTime()),
                    b = f.dateFormat(c.dateFormat, a.x)) : b = B.categories ? w(B.names[a.x], B.categories[a.x], a.x) : a.x);
                    a.splice(v, 0, b)
                })
            }
            m = m.concat(g);
            ...
            b += function(a, b, d) {
                ...
                if (h) {
                    for (e += "<tr>"; g < d; ++g) {
                        h = a[g];
                        var m = a[g + 1];
                        h === m ? ++k : k ? (e += n("th", "highcharts-table-topheading", 'scope="col" colspan="' + (k + 1) + '"', h),
                        k = 0) : (h === b[g] ? c.exporting.useRowspanHeaders ? (m = 2,
                        delete b[g]) : (m = 1,
                        b[g] = "") : m = 1,
                        e += n("th", "highcharts-table-topheading", 'scope="col"' + (1 < m ? ' valign="top" rowspan="' + m + '"' : ""), h))
                    }
                    e += "</tr>"
                }
                if (b) {
        ...
        d.prototype.viewData = function() {
            this.dataTableDiv || (this.dataTableDiv = v.createElement("div"),
        ...
        d.prototype.toggleDataTable = function() {
            var a, c = this.exportDivElements, d = null === (a = null === n || void 0 === n ? void 0 : n.buttons) || void 0 === a ? void 0 : a.contextButton.menuItems;
            a = this.options.lang;
