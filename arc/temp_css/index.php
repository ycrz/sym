...
<body id="t" style="min-height: 90vh !important;">
	<div class="tp-vc-absolute" style="margin: 0 auto">
		<div style="min-width: 90vw !important">
			<div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
			<div class="onlyforchrome" style="font-size: 30px;text-align: center;font-family: Helvetica;">404 SEKOLAK NOT FOUND</div>
				<div class="onlyforchrome" style="margin-top:5px;text-align:center;color:#8a8a8a;margin-bottom:80px; font-size:.8em;line-height:1.2em;font-family: Georgia;">Seperti game google ini, Anda Sedang Tersesat :)<br/> Jika ingin main, Tekan spasi pada keyboard anda.</div>
				<div id="main-frame-notchrome" style="display:none; margin-top:50px;">Maaf Game Ini hanya bisa dimainkan diGoogle Chrome! Download <a href="https://www.google.com/chrome">disini!</a></div>
				...
				<a href="../index">
					<button class="btn">Kembali Ke Menu Utama</button>
				</a>
			</div>
		</div>
	</div>
